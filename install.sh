...
echo -e "\033[0;34m1. pip3 install spotifyfizyfit && spotifyfizyfit /path/to/your/config.json\033[0m"
echo -e "\033[0;34m3. python3 src/runner.py /path/to/your/config.json\033[0m"
...
case "$choice" in
    "1")
        echo -e "\033[0;32mExample command: pip3 install spotifyfizyfit && spotifyfizyfit /path/to/your/spotify-playlist-config.json\033[0m"
        ;;
    "3")
        echo -e "\033[0;32mExample command: python3 src/runner.py /path/to/your/spotify-playlist-config.json\033[0m"
        ;;
    *)
